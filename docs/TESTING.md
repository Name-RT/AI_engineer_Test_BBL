...
เพื่อรับประกันว่าโมเดลตอบข้อมูลตัวเลข สิทธิ์การลา งบประมาณ และกฎระเบียบได้อย่างถูกต้องตรงตาม `data/knowledge_base.txt` ทั้ง 15 หมวดหมู่นโยบาย มีการทดสอบความถูกต้องของข้อเท็จจริง (Factual Verification):
